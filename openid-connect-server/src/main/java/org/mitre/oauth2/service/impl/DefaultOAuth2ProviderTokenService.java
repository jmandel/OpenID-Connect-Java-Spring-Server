...
public class DefaultOAuth2ProviderTokenService implements OAuth2TokenEntityService {
    ...
    public OAuth2AccessTokenEntity createAccessToken(OAuth2Authentication authentication) throws AuthenticationException, InvalidClientException {
		if (authentication != null && authentication.getAuthorizationRequest() != null) {
	    	...
	    	OAuthRequest originalAuthRequest = authHolder.getAuthentication().getAuthorizationRequest();
	...
	@Override
    public OAuth2AccessTokenEntity refreshAccessToken(String refreshTokenValue, OAuthRequest authRequest) throws AuthenticationException {
